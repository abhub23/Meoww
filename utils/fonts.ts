import { Bricolage_Grotesque, Montserrat, Host_Grotesk, DM_Sans, Bangers, Press_Start_2P, Eater, Irish_Grover, Nosifer, Kalnia_Glaze, Rubik_Gemstones } from "next/font/google";

const Bricolage_font = Bricolage_Grotesque()
const Montserrat_font = Montserrat()
const Host_Grotesk_font = Host_Grotesk()
const DM_Sans_font = DM_Sans()
const Kalnia_Glaze_font = Kalnia_Glaze()
const Rubik_Gemstones_font = Rubik_Gemstones({weight: '400'})
const Press_Start_2P_font = Press_Start_2P({weight: '400'})
const Bangers_font = Bangers({weight: '400'})
const Eater_font = Eater({weight: '400'})
const Irish_Grover_font = Irish_Grover({weight: '400'})
const Nosifer_font = Nosifer({weight: '400'})
